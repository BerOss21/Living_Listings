<template>
    <div class="container flex flex-col-reverse gap-4 md:grid md:grid-cols-12">  
        ...
        <div class="flex flex-col gap-4 md:col-span-5">
            ...
            <MakeOffer v-if="page.props.user && !offer" :price="listing.price" :listing_id="listing.id" @amount-modified="amount=$event" />
            <OfferMade v-else-if="page.props.user" :offer="offer"/>
        </div>     
    </div>
</template>
